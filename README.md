...
Minimal Astro template for small static websites with a reusable layout, shared
styles, configurable site identity, and simple page patterns.
...
export const site = {
  ...
  title: "Dans L'Optik",
  description: 'Portfolio photo de Blackfish Creation',
  lang: 'fr',
